...
//Prefab
recipes.addShaped(<prefab:item_basic_structure>.withTag({ForgeCaps: {"prefab:structuresconfiguration": {configuration: {wareHouseFacing: "north", structureEnumName: "AquaBase"}}}, id: "prefab:item_basic_structure", Count: 1 as byte, Damage: 0 as short}),                                         
...
recipes.addShaped(<prefab:item_basic_structure>.withTag({ForgeCaps: {"prefab:structuresconfiguration": {configuration: {wareHouseFacing: "north", structureEnumName: "DefenseBunker"}}}, id: "prefab:item_basic_structure", Count: 1 as byte, Damage: 0 as short}),                                       
[[<tp:reinforced_obsidian>, <torchmaster:mega_torch>, <tp:reinforced_obsidian>],
...
recipes.addShaped(<prefab:item_basic_structure>.withTag({ForgeCaps: {"prefab:structuresconfiguration": {configuration: {wareHouseFacing: "north", structureEnumName: "EnderGateway"}}}, id: "prefab:item_basic_structure", Count: 1 as byte, Damage: 0 as short}),                                       
[[<minecraft:prismarine:1>, <minecraft:chorus_flower>, <minecraft:prismarine:1>],
...
[[<prefab:block_compressed_stone:1>, <ore:paneGlass>, <prefab:block_compressed_stone:1>],
 [<prefab:block_compressed_stone:1>, <forge:bucketfilled>.withTag({FluidName: "fresh_water", Amount: 1000}), <prefab:block_compressed_stone:1>],
...
[[<minecraft:skull>, <minecraft:skull:1>, <minecraft:skull:2>],
